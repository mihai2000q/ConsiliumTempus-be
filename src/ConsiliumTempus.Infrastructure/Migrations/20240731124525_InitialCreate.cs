        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 18, "DeleteProject" },
                    { 19, "AddStatusToProject" },
                    { 20, "ReadStatusesFromProject" },
                    { 21, "UpdateStatusFromProject" },
                    { 22, "RemoveStatusFromProject" },
                    { 23, "ReadAllowedMembersFromProject" },
                    ...
                    { 39, "UpdateIsCompletedProjectTask" },
                    { 40, "UpdateOverviewProjectTask" },
                    { 41, "DeleteProjectTask" }
                });
