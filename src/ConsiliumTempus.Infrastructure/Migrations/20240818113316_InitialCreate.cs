    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomField.Number", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomField.Number_CustomFieldSetup.Number_SetupId",
                        column: x => x.SetupId,
                        principalTable: "CustomFieldSetup.Number",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomField.Text", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomField.Text_CustomFieldSetup.Text_SetupId",
                        column: x => x.SetupId,
                        principalTable: "CustomFieldSetup.Text",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomField.SingleSelect", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SingleSelectOption_CustomFieldSetup.SingleSelect_SetupId",
                        column: x => x.SetupId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "ReadInvitationsFromWorkspace" },
                    { 4, "UpdateWorkspace" },
                    { 5, "UpdateFavoritesWorkspace" },
                    { 6, "UpdateOverviewWorkspace" },
                    { 7, "DeleteWorkspace" },
                    { 8, "InviteCollaboratorToWorkspace" },
                    { 9, "ReadCollaboratorsFromWorkspace" },
                    { 10, "UpdateCollaboratorFromWorkspace" },
                    { 11, "KickCollaboratorFromWorkspace" },
                    { 12, "CreateProject" },
                    { 13, "ReadProject" },
                    { 14, "ReadOverviewProject" },
                    { 15, "ReadCollectionProject" },
                    { 16, "UpdateProject" },
                    { 17, "UpdateFavoritesProject" },
                    { 18, "UpdateOverviewProject" },
                    { 19, "DeleteProject" },
                    { 20, "AddStatusToProject" },
                    { 21, "ReadStatusesFromProject" },
                    { 22, "UpdateStatusFromProject" },
                    { 23, "RemoveStatusFromProject" },
                    { 24, "ReadAllowedMembersFromProject" },
                    { 25, "CreateProjectSprint" },
                    { 26, "ReadProjectSprint" },
                    { 27, "ReadCollectionProjectSprint" },
                    { 28, "UpdateProjectSprint" },
                    { 29, "DeleteProjectSprint" },
                    { 30, "ReadStagesFromProjectSprint" },
                    { 31, "AddStageToProjectSprint" },
                    { 32, "MoveStageFromProjectSprint" },
                    { 33, "UpdateStageFromProjectSprint" },
                    { 34, "RemoveStageFromProjectSprint" },
                    { 35, "CreateProjectTask" },
                    { 36, "ReadProjectTask" },
                    { 37, "ReadCollectionProjectTask" },
                    { 38, "MoveProjectTask" },
                    { 39, "UpdateProjectTask" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomField.SingleSelect_SetupId",
                table: "CustomField.SingleSelect",
                column: "SetupId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomField.Text_ProjectTaskId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomFieldSetup.SingleSelect_DefaultOptionId",
                table: "CustomFieldSetup.SingleSelect",
                column: "DefaultOptionId",
                unique: true,
                filter: "[DefaultOptionId] IS NOT NULL");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_CustomField.SingleSelect_CustomFieldSetup.SingleSelect_SetupId",
                table: "CustomField.SingleSelect",
                column: "SetupId",
                principalTable: "CustomFieldSetup.SingleSelect",
                principalColumn: "Id",
