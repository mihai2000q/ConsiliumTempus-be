        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, "ReadInvitationsFromWorkspace" },
                    ...
                    { 22, "ReadAllowedMembersFromProject" },
                    { 23, "CreateProjectSprint" },
                    { 24, "ReadProjectSprint" },
                    { 25, "ReadCollectionProjectSprint" },
                    { 26, "UpdateProjectSprint" },
                    { 27, "DeleteProjectSprint" },
                    { 28, "ReadStagesFromProjectSprint" },
                    { 29, "AddStageToProjectSprint" },
                    { 30, "MoveStageFromProjectSprint" },
                    { 31, "UpdateStageFromProjectSprint" },
                    { 32, "RemoveStageFromProjectSprint" },
                    { 33, "CreateProjectTask" },
                    { 34, "ReadProjectTask" },
                    { 35, "ReadCollectionProjectTask" },
                    { 36, "MoveProjectTask" },
                    { 37, "UpdateProjectTask" },
                    { 38, "UpdateIsCompletedProjectTask" },
                    { 39, "UpdateOverviewProjectTask" },
                    { 40, "DeleteProjectTask" }
                });
