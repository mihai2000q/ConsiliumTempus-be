...
public sealed class GetInvitationsWorkspaceQueryValidator : AbstractValidator<GetInvitationsWorkspaceQuery>
{
    public GetInvitationsWorkspaceQueryValidator()
    {
        RuleFor(q => q)
            ...
            .WithName(nameof(GetInvitationsWorkspaceQuery.IsSender).Dot(nameof(GetInvitationsWorkspaceQuery.WorkspaceId)));
        ...
        RuleFor(q => q)
            ...
            .WithName(nameof(GetInvitationsWorkspaceQuery.PageSize).Dot(nameof(GetInvitationsWorkspaceQuery.CurrentPage)));
