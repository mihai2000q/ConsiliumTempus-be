    ...
    : BaseIntegrationTest(factory, new ProjectData())
{
    ...
    [Fact]
    public async Task UpdateProject_WhenProjectIsNotPrivate_ShouldReturnSuccessResponse()
    {
        await AssertSuccessfulResponse(ProjectData.Users[4], ProjectData.Projects[^3]);
    }

    [Fact]
    public async Task UpdateProject_WhenProjectIsPrivateAndIsAllowedMember_ShouldReturnSuccessResponse()
    {
        await AssertSuccessfulResponse(ProjectData.Users[0], ProjectData.Projects[^2]);
    }

    [Fact]
    public async Task UpdateProject_WhenProjectIsPrivateButIsNotAllowedMember_ShouldReturnForbiddenResponse()
    {
